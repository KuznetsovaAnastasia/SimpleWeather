...
import com.github.skytoph.simpleweather.data.weather.mapper.SunPositionMapper
...
) : Mappable<SunPosition, HorizonDomainMapper>,
    MappableToDB.Embedded<HorizonDB, HorizonDBMapper> {

    override fun map(mapper: HorizonDomainMapper): SunPosition = mapper.map(sunrise, sunset)
